...
import MFavicon from '../public/paireverlogo.png'
                ...
                <Dropdown as="li" className="ms-2">
                    <Dropdown.Toggle
                        ...
                        <div className="avatar avatar-md avatar-indicators avatar-online">
                            <Image
                                alt="avatar"
                                // src="https://xdmindscom.s3.ap-south-1.amazonaws.com/XDfavicon.svg"
                                src={MFavicon}

                                width={40} // Convert 2.5rem to pixels (assuming 1rem = 16px, 2.5rem = 40px)
                                height={40}
                                className="rounded-circle"
                            />
                        </div>
                ...
                <Dropdown as="li" className="ms-2">
                    <Dropdown.Toggle
                        ...
                        <Image
                                ...
                                // src="https://xdmindscom.s3.ap-south-1.amazonaws.com/XDfavicon.svg"
                                src={MFavicon}
                                width={30} // Convert 2.5rem to pixels (assuming 1rem = 16px, 2.5rem = 40px)
                                height={30}
                                className="rounded-circle"
                            />
                        </div>
