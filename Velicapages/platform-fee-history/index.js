...
import {
  ...
  GetAllAreaofInterstApi,
  GetAllPlatformFeesApi,
                ...
                {paginatedData.length > 0 ? (
                  paginatedData.map((d, i) => (
                    <tr key={d._id}>
                      ...
                      <td className="align-middle text-dark">{d?.fee}</td>
                      <td className="align-middle">
                        <span
                          className="editlist"
                          onClick={() =>
                            router.push(`/platform-fee-history/${d._id}`)
                          }
                        >
